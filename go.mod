...
replace (
	go.opentelemetry.io/otel v1.0.0 => go.opentelemetry.io/otel v0.20.0
	go.opentelemetry.io/otel/exporters/otlp/otlptrace/otlptracegrpc v1.0.0 => go.opentelemetry.io/otel/exporters/otlp/otlptrace/otlptracegrpc v0.20.0
	go.opentelemetry.io/otel/sdk v1.0.0 => go.opentelemetry.io/otel/sdk v0.20.0
)
