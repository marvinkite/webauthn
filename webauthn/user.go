...
type User interface {
	// WebAuthnID returns User ID according to the Relying Party
	WebAuthnID() []byte
	// WebAuthnName returns User Name according to the Relying Party
	WebAuthnName() string
	// WebAuthnDisplayName returns Display Name of the user
	WebAuthnDisplayName() string
	// WebAuthnIcon returns User's icon url
	WebAuthnIcon() string
