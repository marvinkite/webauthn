...
func (metadataService testMetadataService) WebAuthnAuthenticator(aaguid string) *metadata.MetadataStatement {
	if aaguid != "fa2b99dc-9e39-4257-8f92-4a30d23c4118" {
		...
		return &metadata.MetadataStatement{
