...
const (
	...
	// ConformanceMDSRoot certificate.
...
type MetadataBLOBPayloadEntry struct {
	// The Authenticator Attestation ID of the authenticator this metadata BLOB payload entry relates to. See [UAFProtocol] for the definition of the AAID structure. This field MUST be set if the authenticator implements FIDO UAF.
